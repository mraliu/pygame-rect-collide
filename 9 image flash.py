...
# Pygame sprite
m_falcon = pygame.image.load("tiefighter.png").convert()
m_falcon.set_colorkey((255, 255, 255))
m_falcon = pygame.transform.scale(m_falcon, (135,150))
m_falcon = pygame.transform.rotate(m_falcon,(0))
m_falcon_rect = m_falcon.get_rect(topleft=(135,50))

m_falcon2 = m_falcon.copy()
m_falcon_rect2 = m_falcon2.get_rect(topleft=(135,50))

m_falcon2.fill((255, 0, 0, 0), special_flags=pygame.BLEND_RGBA_MULT)
...
while running:
    ...
    screen.blit(m_falcon2, (player_x+200, player_y))
